...
namespace Lean.Gui
{
    ...
    public class LeanDrag : LeanSelectable, IBeginDragHandler, IDragHandler, IEndDragHandler
    {
        ...
        public RectTransform Target { set { target = value; } get { return target; } }
        ...
        public LeanPlayer BeginTransitions { get { if (beginTransitions == null) beginTransitions = new LeanPlayer(); return beginTransitions; } }
        ...
        public LeanPlayer EndTransitions { get { if (endTransitions == null) endTransitions = new LeanPlayer(); return endTransitions; } }
        ...
        public UnityEvent OnBegin { get { if (onBegin == null) { onBegin = new UnityEvent(); } return onBegin; } }
        ...
        public UnityEvent OnEnd { get { if (onEnd == null) { onEnd = new UnityEvent(); } return onEnd; } }
